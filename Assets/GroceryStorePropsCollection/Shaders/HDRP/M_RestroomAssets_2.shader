Shader "HDRP_GroceryStoreProps/M_RestroomAssets_2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Toilet2_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Param", 2D ) = "white" {}
		Material_Texture2D_2( "T_Toilet2_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Toilet2_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Toilet2_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_RestroomAssets_2.hlsl"
