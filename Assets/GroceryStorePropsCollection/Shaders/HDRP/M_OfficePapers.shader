Shader "HDRP_GroceryStoreProps/M_OfficePapers"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Papers_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "Diffuse", 2D ) = "white" {}
		Material_Texture2D_2( "Overlay", 2D ) = "white" {}
		Material_Texture2D_3( "T_Papers_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Papers_Opacity", 2D ) = "white" {}
		Material_Texture2D_5( "T_Papers_Mixed_AO", 2D ) = "white" {}
