...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local8 = (Local6.rgb * ((MaterialFloat3)Material.PreshaderBuffer[1].x));
	MaterialFloat3 Local9 = max(Local8,((MaterialFloat3)0.02000000));
	MaterialFloat3 Local10 = min(Local9,((MaterialFloat3)0.98000002));
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	...
	PixelMaterialInputs.Metallic = Local12.rgb;
