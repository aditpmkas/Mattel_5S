...
{
	Material.PreshaderBuffer[0] = float4(5.000000,0.640000,0.640000,0.640000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.640000,0.640000,0.640000,0.000000);//(Unknown)
...
MaterialFloat3 CustomExpression0(FMaterialPixelParameters Parameters,MaterialFloat3 Lumen,MaterialFloat3 Default)
{
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local5 = PositiveClampedPow(Local4,5.00000000);
	MaterialFloat Local6 = (Local5 * (1.00000000 - 0.04000000));
	MaterialFloat Local7 = (Local6 + 0.04000000);
	MaterialFloat Local8 = (1.00000000 - Local7);
	MaterialFloat Local9 = PositiveClampedPow(Local8,Material.PreshaderBuffer[0].x);
	MaterialFloat3 Local10 = (((MaterialFloat3)Local9) * Material.PreshaderBuffer[0].yzw);
	MaterialFloat3 Local11 = CustomExpression0(Parameters,Material.PreshaderBuffer[1].xyz,Local10);
	MaterialFloat3 Local12 = lerp(Local11,Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].w);
	MaterialFloat2 Local13 = Parameters.TexCoords[0].xy;
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local13), 0);
	MaterialFloat4 Local15 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local13),View.MaterialTextureMipBias));
