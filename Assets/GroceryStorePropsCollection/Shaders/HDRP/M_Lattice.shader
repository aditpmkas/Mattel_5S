Shader "HDRP_GroceryStoreProps/M_Lattice"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Lattice1_normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Lattice1_basecolor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Lattice1_metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Lattice1_roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Lattice1_Opacity", 2D ) = "white" {}
		Material_Texture2D_5( "T_Lattice1_AO", 2D ) = "white" {}
