Shader "HDRP_GroceryStoreProps/M_Baggage"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Baggage_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Baggage_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Baggage_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Baggage_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Baggage_AO", 2D ) = "white" {}
