Shader "HDRP_GroceryStoreProps/M_EengineeringCommunications_2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Communications2_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "T_Communications2_Base_Color", 2D ) = "white" {}
		Material_Texture2D_2( "T_Communications2_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Communications2_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Communications2_Mixed_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_EengineeringCommunications_2.hlsl"
