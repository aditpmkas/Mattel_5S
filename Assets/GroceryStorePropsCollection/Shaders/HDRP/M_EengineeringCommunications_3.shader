Shader "HDRP_GroceryStoreProps/M_EengineeringCommunications_3"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Communication3_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "T_Communication3_Base_Color", 2D ) = "white" {}
		Material_Texture2D_2( "T_Communication3_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Communication3_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Communication3_Mixed_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_EengineeringCommunications_3.hlsl"
