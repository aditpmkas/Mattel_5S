...
{
	Material.PreshaderBuffer[0] = float4(7.000000,1.000000,0.820270,0.592640);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local4 = dot(WorldNormalCopy,Parameters.CameraVector);
	MaterialFloat Local5 = max(0.00000000,Local4);
	MaterialFloat Local6 = (1.00000000 - Local5);
	MaterialFloat Local7 = abs(Local6);
	MaterialFloat Local8 = max(Local7,0.00010000);
	MaterialFloat Local9 = PositiveClampedPow(Local8,5.00000000);
	MaterialFloat Local10 = (Local9 * (1.00000000 - 0.04000000));
	MaterialFloat Local11 = (Local10 + 0.04000000);
	MaterialFloat Local12 = (1.00000000 - Local11);
	MaterialFloat Local13 = PositiveClampedPow(Local12,Material.PreshaderBuffer[0].x);
	MaterialFloat Local14 = max(Local13,0.40000001);
	MaterialFloat Local15 = min(Local14,1.00000000);
	MaterialFloat3 Local16 = (((MaterialFloat3)Local15) * Material.PreshaderBuffer[0].yzw);
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 5);
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 5);
	MaterialFloat3 Local20 = (Local16 * Local18.rgb);
	MaterialFloat3 Local21 = lerp(Local20,Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat Local22 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local23 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local24 = MaterialStoreTexSample(Parameters, Local23, 0);
	MaterialFloat Local25 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local26 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local27 = MaterialStoreTexSample(Parameters, Local26, 1);
	MaterialFloat Local28 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	MaterialFloat4 Local29 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local30 = MaterialStoreTexSample(Parameters, Local29, 2);
	MaterialFloat Local31 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local32 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,samplerMaterial_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Metallic = Local26.rgb;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local29.rgb;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local2.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local32.rgb;
