Shader "HDRP_GroceryStoreProps/M_Doors2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Doors2_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "T_Doors2_Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "T_Doors2_Base_Color", 2D ) = "white" {}
		Material_Texture2D_3( "T_Doors2_Metallic", 2D ) = "white" {}
		Material_Texture2D_4( "T_Doors2_Roughness", 2D ) = "white" {}
		Material_Texture2D_5( "T_Doors2_Opacity", 2D ) = "white" {}
		Material_Texture2D_6( "T_Doors2_Mixed_AO", 2D ) = "white" {}
