Shader "HDRP_GroceryStoreProps/M_Pots"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Pots_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Pots_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Pots_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Pots_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Pots_AO", 2D ) = "white" {}
