Shader "HDRP_GroceryStoreProps/M_CleaningAssets"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CleaningAssets_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_CleaningAssets_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_CleaningAssets_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_CleaningAssets_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_CleaningAssets_AO", 2D ) = "white" {}
