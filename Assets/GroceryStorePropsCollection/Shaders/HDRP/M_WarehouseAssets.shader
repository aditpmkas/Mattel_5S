Shader "HDRP_GroceryStoreProps/M_WarehouseAssets"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_WarehouseAssets_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "T_WarehouseAssets_Base_Color", 2D ) = "white" {}
		Material_Texture2D_2( "T_WarehouseAssets_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_WarehouseAssets_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_WarehouseAssets_Mixed_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_WarehouseAssets.hlsl"
