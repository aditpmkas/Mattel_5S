Shader "HDRP_GroceryStoreProps/M_SecurityRoom"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_SecurityRoom_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_SecurityRoom_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_SecurityRoom_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_SecurityRoom_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_SecurityRoom_AO", 2D ) = "white" {}
