Shader "HDRP_GroceryStoreProps/M_OfficeKitchen"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_OfficeKitchen_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_OfficeKitchen_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_OfficeKitchen_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_OfficeKitchen_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_OfficeKitchen_AO", 2D ) = "white" {}
