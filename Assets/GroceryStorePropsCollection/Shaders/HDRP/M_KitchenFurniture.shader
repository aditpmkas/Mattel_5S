Shader "HDRP_GroceryStoreProps/M_KitchenFurniture"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_KitchenFurniture_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_KitchenFurniture_Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "T_KitchenFurniture_BaseColor", 2D ) = "white" {}
		Material_Texture2D_3( "T_KitchenFurniture_Metallic", 2D ) = "white" {}
		Material_Texture2D_4( "T_KitchenFurniture_Roughness", 2D ) = "white" {}
		Material_Texture2D_5( "T_KitchenFurniture_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_KitchenFurniture.hlsl"
