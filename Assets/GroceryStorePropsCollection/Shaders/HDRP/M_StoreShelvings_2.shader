Shader "HDRP_GroceryStoreProps/M_StoreShelvings_2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_StoreShelvings_2_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_StoreShelvings_2_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_StoreShelvings_2_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_StoreShelvings_2_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_StoreShelvings_2_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_StoreShelvings_2.hlsl"
