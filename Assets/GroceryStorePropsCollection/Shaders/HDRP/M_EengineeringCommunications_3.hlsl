...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local8 = Parameters.VertexColor;
	MaterialFloat3 Local9 = DERIV_BASE_VALUE(Local8).rgb;
	MaterialFloat3 Local10 = (Local6.rgb * DERIV_BASE_VALUE(Local9));
	...
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
