...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.095833,0.095833,0.095833,0.800000);//(Unknown)
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local10 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local11 = MaterialStoreTexSample(Parameters, Local10, 2);
	MaterialFloat3 Local12 = lerp(Local8,Material.PreshaderBuffer[2].xyz,Local10.rgb);
	MaterialFloat3 Local13 = lerp(Local8,Local12,0.50000000);
	MaterialFloat3 Local14 = lerp(Local10.rgb,((MaterialFloat3)0.00000000),0.50000000);
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	...
	MaterialFloat3 Local18 = lerp(Local16.rgb,((MaterialFloat3)Material.PreshaderBuffer[2].w),0.50000000);
	...
	PixelMaterialInputs.AmbientOcclusion = Local20.rgb;
