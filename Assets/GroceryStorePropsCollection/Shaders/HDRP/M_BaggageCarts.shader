Shader "HDRP_GroceryStoreProps/M_BaggageCarts"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_BaggageCarts_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_BaggageCarts_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_BaggageCarts_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_BaggageCarts_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_BaggageCarts_AO", 2D ) = "white" {}
