Shader "HDRP_GroceryStoreProps/M_PaintedMetal"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_PaintedMetal_normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_PaintedMetal_basecolor", 2D ) = "white" {}
		Material_Texture2D_2( "Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_PaintedMetal_roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_PaintedMetal_ambientocclusion", 2D ) = "white" {}
