...
{
	Material.PreshaderBuffer[0] = float4(500.000000,1.000000,1.000000,1.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local16 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 0);
	MaterialFloat3 Local18 = lerp(Local14,Local11.rgb,Local16.r);
	...
	PixelMaterialInputs.Metallic = Local16.rgb;
