...
{
	Material.PreshaderBuffer[0] = float4(2.000000,0.200000,0.200000,0.200000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local8 = (Local7 * Material.PreshaderBuffer[0].yzw);
	MaterialFloat3 Local9 = lerp(Local8,Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	...
	MaterialFloat3 Local14 = max(Local13,((MaterialFloat3)0.01000000));
	MaterialFloat3 Local15 = min(Local14,((MaterialFloat3)0.99000001));
