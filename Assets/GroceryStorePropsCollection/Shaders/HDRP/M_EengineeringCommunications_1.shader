Shader "HDRP_GroceryStoreProps/M_EengineeringCommunications_1"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Communication_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Communication_Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "T_Communication_BaseColor", 2D ) = "white" {}
		Material_Texture2D_3( "T_Communication_Metallic", 2D ) = "white" {}
		Material_Texture2D_4( "T_Communication_Roughness", 2D ) = "white" {}
		Material_Texture2D_5( "T_Communication_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_EengineeringCommunications_1.hlsl"
