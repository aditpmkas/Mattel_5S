Shader "HDRP_GroceryStoreProps/M_GarbagePackage"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_GarbagePackage_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_GarbagePackage_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_GarbagePackage_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_GarbagePackage_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_GarbaePackage_Alpha", 2D ) = "white" {}
		Material_Texture2D_5( "T_GarbagePackage_AO", 2D ) = "white" {}
