Shader "HDRP_GroceryStoreProps/M_Grocery2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Grocery2_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "T_Grocery2_Base_Color", 2D ) = "white" {}
		Material_Texture2D_2( "T_Grocery2_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Grocery2_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Grocery2_Opacity", 2D ) = "white" {}
		Material_Texture2D_5( "T_Grocery2_Mixed_AO", 2D ) = "white" {}
