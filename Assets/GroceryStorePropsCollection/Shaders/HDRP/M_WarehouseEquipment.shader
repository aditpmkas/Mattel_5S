Shader "HDRP_GroceryStoreProps/M_WarehouseEquipment"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_WarehouseEquipment_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "T_WarehouseEquipment_Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "T_WarehouseEquipment_Base_Color", 2D ) = "white" {}
		Material_Texture2D_3( "T_WarehouseEquipment_Metallic", 2D ) = "white" {}
		Material_Texture2D_4( "T_WarehouseEquipment_Roughness", 2D ) = "white" {}
		Material_Texture2D_5( "T_WarehouseEquipment_Mixed_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_WarehouseEquipment.hlsl"
