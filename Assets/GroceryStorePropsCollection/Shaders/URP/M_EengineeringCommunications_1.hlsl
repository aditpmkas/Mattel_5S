...
{
	Material.PreshaderBuffer[0] = float4(2.000000,1.000000,0.912775,0.758253);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local8 = (Material.PreshaderBuffer[0].yzw * Local7);
	MaterialFloat4 Local9 = Parameters.VertexColor;
	MaterialFloat3 Local10 = DERIV_BASE_VALUE(Local9).rgb;
	MaterialFloat3 Local11 = (Local8 * DERIV_BASE_VALUE(Local10));
	MaterialFloat3 Local12 = lerp(Local11,Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 3);
	MaterialFloat3 Local16 = (Local14.rgb * Material.PreshaderBuffer[2].xyz);
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local18 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 0);
	MaterialFloat Local20 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local21 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local22 = MaterialStoreTexSample(Parameters, Local21, 4);
	MaterialFloat3 Local23 = (Local21.rgb * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	MaterialFloat Local24 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	MaterialFloat4 Local25 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,samplerMaterial_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Metallic = Local18.rgb;
	...
	PixelMaterialInputs.AmbientOcclusion = Local25.rgb;
