...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local15 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 4);
	MaterialFloat Local17 = dot(Local2.rgb,Parameters.CameraVector);
	MaterialFloat Local18 = max(0.00000000,Local17);
	MaterialFloat Local19 = (1.00000000 - Local18);
	MaterialFloat Local20 = abs(Local19);
	MaterialFloat Local21 = max(Local20,0.00010000);
	MaterialFloat Local22 = PositiveClampedPow(Local21,5.00000000);
	MaterialFloat Local23 = (Local22 * (1.00000000 - 0.04000000));
	MaterialFloat Local24 = (Local23 + 0.04000000);
	MaterialFloat Local25 = lerp(1.00000000,1.01499999,Local24);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = 0.30000001;
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local25,0.0f),Material.PreshaderBuffer[1].x);
