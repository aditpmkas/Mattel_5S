...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 6);
	...
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 6);
	MaterialFloat3 Local7 = lerp(Local5.rgb,Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 5);
	...
	MaterialFloat4 Local11 = Parameters.VertexColor;
	MaterialFloat3 Local12 = DERIV_BASE_VALUE(Local11).rgb;
	MaterialFloat3 Local13 = (Local9.rgb * DERIV_BASE_VALUE(Local12));
	...
	MaterialFloat3 Local17 = lerp(Local13,Local9.rgb,Local15.rgb);
	MaterialFloat Local18 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	...
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	MaterialFloat4 Local22 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_5,samplerMaterial_Texture2D_5,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 3);
	MaterialFloat Local24 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local25 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,samplerMaterial_Texture2D_6,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local26 = MaterialStoreTexSample(Parameters, Local25, 4);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local22.rgb;
	PixelMaterialInputs.BaseColor = Local17;
	PixelMaterialInputs.Metallic = Local15.rgb;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local19.rgb;
