...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local8 = (Local6.rgb * ((MaterialFloat3)1.75000000));
	MaterialFloat3 Local9 = saturate(Local8);
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local11 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Metallic = Local11.rgb;
