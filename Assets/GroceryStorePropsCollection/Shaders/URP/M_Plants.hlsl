...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local12 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	...
	PixelMaterialInputs.OpacityMask = Local12.rgb;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local6.rgb,Material.PreshaderBuffer[1].x);
