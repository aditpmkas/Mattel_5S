...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	...
	MaterialFloat3 Local13 = lerp(Local6.rgb,Local8,Local12);
	MaterialFloat3 Local14 = (Local13 * ((MaterialFloat3)Material.PreshaderBuffer[1].w));
	MaterialFloat3 Local15 = saturate(Local14);
	MaterialFloat3 Local16 = (Local10.rgb * ((MaterialFloat3)Material.PreshaderBuffer[2].x));
	...
	MaterialFloat Local20 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	...
	PixelMaterialInputs.Roughness = Local18.rgb;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local2.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local21.rgb;
